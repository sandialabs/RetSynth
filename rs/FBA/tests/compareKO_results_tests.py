...
class RuncompareKO_resultsTests(unittest.TestCase):
    def setUp(self):
        ...
        self.ex_info = ei.Extract_Information(osp, inmets, inrxns, DB)
        self.fba = bm.BuildModel('t1', inmets, inrxns, DB, False)
        ...
        self.optimized_fba = ot.OptimizeTarget('cpdT_c0', 't1',
                                               ...
                                               inmets, inrxns, DB, False, KO=True, remove=True)
    def tearDown(self):
    ...
    def test_compareKO_results(self):
        ...
        comparisonKOresults = crko.CompareKO('cpd08373_c0', self.fba.compounds_dict, self.optimized_fba.fbasol,
