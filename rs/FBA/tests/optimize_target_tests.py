...
model = cobra.io.read_sbml_model(PATH+'/data/test1.xml')
...
class RunOptimizeTargetTests(unittest.TestCase):
    ...
    def test_optimize_target(self):
        ...
        optimal_pathways = [['rxn1_c0_F', 'rxn2_c0', 'rxn3_c0_F']]
        ex_info = ei.Extract_Information(optimal_pathways, inmets, DB)
