...
osp = [['rxn1_c0_F', 'rxn2_c0_R', 'rxn3_c0_R']]
ex_info = ei.Extract_Information(osp, inmets, inrxns, DB)
    ...
    def test_compare_results(self):
        ...
        for r, fluxvalue in comparisonresults.fluxchange.iteritems():
            ...
            if match is not None:
                ...
                if org_fbasolution.fluxes[r] == 0 and optimized_fba.model.solution.fluxes[r] != 0:
                    self.assertEqual(values[0], 0)
                    self.assertTrue(values[1] > 1 or values[1] < -1)
                elif (org_fbasolution.fluxes[r] != 0 and
                      optimized_fba.model.solution.fluxes[r] != 0):
                ...
                if r not in org_fbasolution.fluxes:
