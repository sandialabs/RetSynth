...
bkdb.BuildKbase(PATH+'/data', PPATH+'/KbasetoKEGGCPD.txt', PPATH+'/KbasetoKEGGRXN.txt', False, PATH+'/test.db', 'bio')
...
class Generate_databaseTests(unittest.TestCase):
    ...
    def test_get_compound_compartment(self):
        ...
        hit = DB.get_compound_compartment('cpdA_c0')
