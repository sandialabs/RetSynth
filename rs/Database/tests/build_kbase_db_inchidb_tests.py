...
class Generate_databaseTests_PubchemTrue(unittest.TestCase):
    ...
    def test_generate_db(self):
        ...
        self.assertIn(('InChI=1S/C20H15ClF2N2O2/c21-14-6-4-13(5-7-14)12-27-15-8-9-24-19(10-15)25-20(26)11-16-17(22)2-1-3-18(16)23/h1-10H,11-12H2,(H,24,25,26)_c0', 'cpdA_c0', 'c0', 'None'), results_compound)
        self.assertIn(('cpdB_c0', 'cpdB_c0', 'c0', 'None'), results_compound)
        self.assertIn(('InChI=1S/C6H10O6/c7-2-5(10)3(8)1-4(9)6(11)12/h3,5,7-8,10H,1-2H2,(H,11,12)/t3-,5+/m0/s1_c0', '2_keto_3_deoxygluconate_c0', 'c0', 'None'), results_compound)
        self.assertIn(('InChI=1S/2ClH.2H2N.Pt/h2*1H;2*1H2;/q;;2*-1;+4/p-2_c0', 'cpdC_c0', 'c0', 'None'), results_compound)
