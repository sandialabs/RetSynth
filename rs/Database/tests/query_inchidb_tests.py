...
class Generate_databaseTests(unittest.TestCase):
    ...
    def test_get_compound_name(self):
        ...
        hit = self.DB.get_compound_name('InChI=1S/C6H10O6/c7-2-5(10)3(8)1-4(9)6(11)12/h3,5,7-8,10H,1-2H2,(H,11,12)/t3-,5+/m0/s1_c0')
        self.assertEqual('2_keto_3_deoxygluconate_c0', hit)

    def test_get_reactions(self):
        print ("Testing the get_reactions() function")
        hits = self.DB.get_reactions('InChI=1S/C6H10O6/c7-2-5(10)3(8)1-4(9)6(11)12/h3,5,7-8,10H,1-2H2,(H,11,12)/t3-,5+/m0/s1_c0', 1)
        self.assertIn('rxn13_c0', hits)
        hits = self.DB.get_reactions('InChI=1S/C6H10O6/c7-2-5(10)3(8)1-4(9)6(11)12/h3,5,7-8,10H,1-2H2,(H,11,12)/t3-,5+/m0/s1_c0', 0)
    ...
    def test_get_stoichiometry(self):
        ...
        hit = self.DB.get_stoichiometry('rxn1_c0', 'InChI=1S/C20H15ClF2N2O2/c21-14-6-4-13(5-7-14)12-27-15-8-9-24-19(10-15)25-20(26)11-16-17(22)2-1-3-18(16)23/h1-10H,11-12H2,(H,24,25,26)_c0', 0)
        self.assertEqual(hit[0], 1)
        hit = self.DB.get_stoichiometry('rxn1_c0', 'cpdT_c0', 1)
        self.assertEqual(hit[0], 1)
    ...
    def test_get_compound_compartment(self):
        ...
        hit = self.DB.get_compound_compartment('InChI=1S/C20H15ClF2N2O2/c21-14-6-4-13(5-7-14)12-27-15-8-9-24-19(10-15)25-20(26)11-16-17(22)2-1-3-18(16)23/h1-10H,11-12H2,(H,24,25,26)_c0')
