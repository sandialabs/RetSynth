...
inrxns = DB.get_compounds_in_model('t1')
...
class ExtrainfoTests(unittest.TestCase):
    ...
    def test_extrainfo(self):
        ...
        print ("Tests that correct information about compounds, reactions and organisms is being retrieved")
        ...
        print ("...Testing that correct reaction information (directionality and name) was retrieved")
